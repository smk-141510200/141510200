              ...
              <input name="_method" type="hidden" value="PATCH"> 
                 ...
                 <div class="form-group{{ $errors->has('kode_jabatan') ? ' has-error' : '' }}"> 
                          <label for="kode_jabatan" class="col-md-4 control-label">Kode Jabatan :</label> 
                              <div class="col-md-6"> 
                                  <input type="text" name="kode_jabatan" title="KG...." value="{{$jabatan->kode_jabatan}}" class="form-control" > 
                  ...
                  <div class="form-group{{ $errors->has('nama_jabatan') ? ' has-error' : '' }}">                           <label for="nama_jabatan" class="col-md-4 control-label">Nama Jabatan :</label> 
                              <div class="col-md-6"> 
